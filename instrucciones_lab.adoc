...
Para comenzar a realizar nuestra configuración crearemos un nuevo datacenter con el nombre *TestDrive*.

image::./img/Lab3_1.1.png[Creacion de Datacenter]

Dé click en el ícono *Crear Clúster*

image::./img/Lab3_2.png[Creacion de Cluster]

Verifique que la información de los campos sea igual a la de la imagen.

image::./img/Lab3_3.png[Datos Cluster ]

Dé click en el ícono de *Configurar Host*

image::./img/Lab3_4.png[Instalación de Hipervisor]

Verifique que la información a reserva de la ip sea similar a la de la imagen.
